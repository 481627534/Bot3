        ...
        try {
            ...
            if (success) {
                ...
                if (links.getA() != null && !links.getA().trim().equals("")) {
                    generateLinks.append("\n*Download A-Only:* [SourceForge](http://sourceforge.net/projects/trebleexperience/files/GSI/").append(links.getA()).append(")");
                }
                if (links.getAb() != null && !links.getAb().trim().equals("")) {
                    generateLinks.append("\n*Download A/B:* [SourceForge](http://sourceforge.net/projects/trebleexperience/files/GSI/").append(links.getAb()).append(")");
                }
                if (links.getFolder() != null && !links.getFolder().trim().equals("")) {
                    generateLinks.append("\n*View:* [SourceForge Folder](http://sourceforge.net/projects/trebleexperience/files/GSI").append(links.getFolder()).append(")");
                }
                ...
                bot.sendMessage("*GSI: " + gsiCmdObj.getGsi() + "*\n\n"
                        ...
                        + "\n\n*Thanks to:* [Contributors List](https://github.com/Treble-Experience/ErfanGSIs-Hitsuki/graphs/contributors)"
                        + "\n\n[Ported using ErfanGSIs Tool](https://github.com/Treble-Experience/ErfanGSIs-Hitsuki)", update);
